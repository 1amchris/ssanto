...
class Analysis(TenantInstance, metaclass=TenantSingleton):
    ...
    # This uses the old objective hierarchy format
    ...
    #             # We dont add the analysis, but we could
    #         },
    #         "files": self.files_manager.serialize(),
    #     }

    # the files are no longer added to the analysis
    ...
    # the files are no longer removed to the analysis
    ...
    # I believe this (add_layer, remove_layer, get_layer) should be extracted to a "Map/Layer manager" class
    ...
    def objectives_data_update(self):
        ...
        print("objectives_data_update (does nothing)")

    # uses the old objective hierarchy format
    def distribution_update(self):
        ...
        print("distribution_update (does nothing)")
    ...
    # I believe this whole 'update' method will no longer be needed,
    #  as the document editor is used to update the objectives
    ...
    # I believe this whole 'receive_study_area' method will no longer be needed,
    #  as the document editor is used to update the objectives
