...
class Interface:
    def __init__(self, subjects_manager):
        ...
        self.add_left_category("Analysis parameters").add_form().bind("parameters").add_text_input(
            "Analysis name", "analysis_name"
        ).add_text_input("Name of the modeler", "modeler_name").add_size_input("Cell size", "cell_size")
